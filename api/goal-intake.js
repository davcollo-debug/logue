...
<body>
    ...
    <script type="text/babel">
        ...
        const RefreshCw = ({className}) => <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className={className}><path d="M3 12a9 9 0 0 1 9-9 9.75 9.75 0 0 1 6.74 2.74L21 8"/><path d="M21 3v5h-5"/><path d="M21 12a9 9 0 0 1-9 9 9.75 9.75 0 0 1-6.74-2.74L3 16"/><path d="M3 21v-5h5"/></svg>;

        function App() {
          const [user, setUser] = useState(null);
          const [loading, setLoading] = useState(true);
          const [phase, setPhase] = useState('connect'); // 'connect', 'goal_intake', 'main'
            ...
            try {
              if (phase === 'goal_intake') {
                ...
                if (data.isComplete && data.goalData) {
                  ...
                  setMessages(prev => [...prev, {
                    role: 'assistant',
                    content: 'Great! Let me analyze your recent training to understand your current fitness level...',
                    timestamp: Date.now()
                  }]);
            ...
            return (
              <div className="h-screen flex flex-col bg-gray-50">
                <div className="bg-white border-b px-6 py-4 shadow-sm">
                  <h1 className="text-lg font-semibold text-gray-800">Logue • Goal Setup</h1>
                </div>
